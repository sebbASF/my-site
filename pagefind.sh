...
mv ${PELICAN_OUTPUT_PATH}/index.html ${PELICAN_OUTPUT_PATH}/index.tmp
${PAGEFIND} --site ${PELICAN_OUTPUT_PATH} --output-subdir "_pagefind"
mv ${PELICAN_OUTPUT_PATH}/index.tmp ${PELICAN_OUTPUT_PATH}/index.html
